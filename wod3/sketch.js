...
function setup() {
  ...
  noStroke();
  for (let i = 0; i < 200; i++) {// create x flowers 
...
function draw() {
  ...
  //draw the planet
  drawEarth(100);
  //title for album wrapped round teh earth
  drawCurvedText("SGURD NO DLRW", 102, 0);// backwards to save me figuring out how to flip text 
  drawFlowers();
...
function drawCurvedText(txt, radius, yOffset) {
  push();
  ...
  let angleStep = PI / txt.length * 0.5;// makes the letter less spaced ouyt 
  let startAngle = -PI / 2;// 
